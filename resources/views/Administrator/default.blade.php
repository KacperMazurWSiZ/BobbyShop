        ...
        <div class="header navbar">
            <div class="header-container">
                ...
                <ul class="nav-right">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li>
                                <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                                    @foreach(\App\Models\Notification::all()->take(3) as $notification)
                                        <li>
                                        <a href="" class="peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100">
                                            ...
                                            <div class="peer peer-greed">
                            <span>
                              <span class="c-grey-600"> {{ $notification->notification_body }} </span>
                              </span>
                            </span>
                                                <p class="m-0">
                                                    <small class="fsz-xs">{{ \Carbon\Carbon::parse($notification->created_at)->diffForHumans() }}</small>
                                                </p>
                                            </div>
                                        </a>
                                    </li>
                    ...
                    <span>
                      <a href="{{ route('admin.notification.index') }}" class="c-grey-600 cH-blue fsz-sm td-n">View All Notifications <i class="ti-angle-right fsz-xs mL-10"></i></a>
                    </span>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu fsz-sm">
                            <li>
                                <a href="{{route('admin.profile')}}" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
